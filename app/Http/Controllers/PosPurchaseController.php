...
//            ->limit(9)->get();
        ...
        <ul class='products-list sugg-list'>
            ...
            foreach ($products as $row) {
                ...
                <li tabindex='<?php echo $i; ?>'
                    onclick='selectProducts("<?php echo $id; ?>", "<?php echo $name; ?>", "<?php echo $price; ?>", "<?php echo $serial; ?>" , "<?php echo $vat; ?>" , "<?php echo $pbq; ?>" , "<?php echo $su; ?>" , "<?php echo $u; ?>" );'
                    data-id='<?php echo $id; ?>' data-name='<?php echo $name; ?>' data-price='<?php echo $price; ?>'
                    data-pbq='<?php echo $pbq; ?>' data-serial='<?php echo $serial; ?>'>  <?php echo $name; ?> </li>
    ...
    public function get_purchase_return_products(Request $req)
    {
        ...
        $s_text = $req['s_text'];
        $memo = $req['supp_memo'];
        $products_id = PurchaseDetails::where('pur_inv', $memo)->pluck('pid');
