                ...
                <table id="Pendings" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$confirmed->shipping_method}}</td>
  ...
  $(document).ready(function() {
    ...
    function load_data(from_date = '', to_date = ''){
      $("#Pendings").DataTable({
        ...
        ajax: {
          url: '{{ route("admin.orders.confirmed") }}',
    ...
    $('#refresh').click(function(){
      ...
      $('#selectAction').change(function(){
        ...
        if(take_value == "delivered"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.confirm-delivered') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
        ...
        if(take_value == "cancel"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.confirm-cancel') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
        ...
        if(take_value == "paid"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.confirm-paid') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
