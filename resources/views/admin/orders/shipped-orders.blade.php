  ...
  $(document).ready(function() {
    ...
    function load_data(from_date = '', to_date = ''){
      $("#Pendings").DataTable({
        ...
        ajax: {
          url: '{{ route("admin.orders.shipped") }}',
    ...
    $('#refresh').click(function(){
      ...
      $('#selectAction').change(function(){
        ...
        if(take_value == "delivered"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.shipped-delivered') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
        ...
        if(take_value == "paid"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.shipped-paid') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
        ...
        if(take_value == "cancel"){
          ...
          $.ajax({
              url: "{{ URL::route('admin.orders.shipped-cancel') }}",
              method: 'post',
              data: formData,
              contentType: false,
              cache: false,
