                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="card card-widget widget-user-2">
                              ...
                              <div class="card-body">
                                <b><i class="fa fa-globe mr-2"></i> {{ $setting->site_name }}</b> <br>
                                <span><i class="fa fa-map-marker-alt mr-2"></i> {{ $setting->site_address }}</span> <br>
                                <span><i class="fa fa-phone mr-2"></i> {{ $setting->phone }}</span>
                              </div>
                            </div>
                            <!-- End Account Summary -->
                          </div>
