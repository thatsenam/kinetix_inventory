                                            ...
                                            <div class="row">
                                                ...
                                                @else
                                                    <input type="hidden" name="warehouse_id" id="warehouse_id"
                                                           value="{{ $warehouse_id }}">
                                                    <div class="col-1">
                                                        <div onclick="addNewSupplier()"><i
                                                                class="fas fa-plus-square fa-2x mt-1 pl-2"
                                                                style="cursor: pointer; color: #1bceb3;"></i></div>
...
@section('page-js-script')
    ...
    <script type="text/javascript">
        ...
        function remove(id) {
            ...
            let box = this_selected_row.closest('tr').find('.box');
            // var product = Number($(this).closest('tr').find(".name").attr('data-prodid'));


            qnt.text(Number((qnt).text()) - 1)
            box.text(Number((qnt).text()))


            let product_id = $('#product_id').val();

            let serial = serial_array[product_id];


            document.getElementById("serial_div-" + id).remove();
