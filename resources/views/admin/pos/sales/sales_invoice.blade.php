...
@section('page-js-script')
    ...
    <script type="text/javascript">
        ...
        function add_product_to_table(id, name, qnt, price, totalPrice, pvat, vat, price_per_kg, box) {
            ...
            $('.price-table').append("<tr data-vat='" + calculate_vat + "'><td class='name' data-prodid='" + id + "' style='width:200px;'>" + name + "</td><td class='box'>" + box + "</td><td class='qnty'>" + qnt + "</td><td class='uprice'>" + price + "</td><td class='prod_vat'" + hidden_class + ">" + calculate_vat + "</td><td class='totalPriceTd'>" + total + "</td><td><i class='delete mdi mdi-delete'></i></td></tr>");
