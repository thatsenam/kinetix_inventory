                        ...
                        <table class="table" style="width: 600px; margin: 0 auto;">
                            <tr>
                                ...
                                <td style="position: relative;">
                                    ...
                                    <input type="hidden" name="db_name" id="db_name" value="0" class="form-control">
                            ...
                            <tr>
                                <td>
                                    <label>License Activate From</label>
                                </td>
                                
                                <td>
                                    <input type="text" name="license_from" id="license_from" class="form-control" value="<?php echo date('Y-m-d');?>">
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
                        ...
                        $('.client-list').find("li:first").focus().addClass('activex').siblings().removeClass();
                            ...
                            $('.client-list').on('keyup', function(e){
                                ...
                                if(e.which == 13){
                                   ...
                                   var db_name = $(".activex").attr("data-dbname");
        ...
        $('#save').click(function(){
            ...
            var license_from = $('#license_from').val();
            ...
            var formData = new FormData();
        	    ...
        	    formData.append('license_from', license_from);
             ...
             $.ajaxSetup({
                ...
                $.ajax({
            		  url: "{{ URL::route('save_license_registration') }}",
                      method: 'post',
                      data: formData,
                      contentType: false,
                      cache: false,
