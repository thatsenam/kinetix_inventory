    ...
    <div class="card-body">
        <form>
            <div class="row">
                ...
                <div class="col-md-4">
                    <label for="sub_head" class="font-weight-bold">উপ-খাত</label>
                ...
                <div class="col-md-3">
                    <label for="head" class="font-weight-bold">খাত</label>
                ...
                <div class="col-md-2 d-flex align-items-end">
                    <button wire:click.prevent="store" type="submit" class="btn btn-success rounded-0">সেভ</button>
                </div>
            </div>
        </form>
    </div>
