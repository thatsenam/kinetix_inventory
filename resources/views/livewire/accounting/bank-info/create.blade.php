    ...
    <div class="card-body">
        <form wire:submit.prevent = "store">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="name" class="col-sm-4 col-form-label text-dark font-weight-bold">
                            Bank Name 
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="type" class="col-sm-4 col-form-label text-dark font-weight-bold">
                            Type
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="acc_name" class="col-sm-4 col-form-label text-dark font-weight-bold">
                            Account Name
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="acc_number" class="col-sm-4 col-form-label text-dark font-weight-bold">
                            Account Number
                            <span class="text-danger">*</span>
                        </label>
                        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="card_name" class="col-sm-4 col-form-label text-dark font-weight-bold">Card Name</label>
                        <div class="col-md-8">
                ...
                <div class="col-md-6">
                    <div class="form-group row">
                        <label for="balance" class="col-sm-4 col-form-label text-dark font-weight-bold">Balance</label>
                        <div class="col-md-8">
