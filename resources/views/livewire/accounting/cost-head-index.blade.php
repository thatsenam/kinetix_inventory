<div>
    @section('title', 'ব্যয় খাত')

    <div>
        <h1 class="ml-3">ব্যয় খাত</h1>
        

        @if($updateAccHead)
            @include('livewire.accounting.acc-head.cost_edit')
        @else
            @include('livewire.accounting.acc-head.cost_create')
        @endif
            ...
            @forelse ($acc_heads as $acc_head)
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        ...
                        <button wire:click.prevent="destroy({{ $acc_head->id }})" class="btn btn-danger rounded-0">
