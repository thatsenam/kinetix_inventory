...
{{--                            <div class=""> <?= $pro_image ?> </div>--}}
                            <h4 class="mb-2 mt-2">{{$user_info->billing_name ?? "N/A"}}</h4>
                            ...
                            <div class="mgtp-20">
                                <table class="table table-sm table-striped table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="badge badge-success">{{$user_info->status  ?? "N/A"}}</span></td>
                                    </tr>
                                    <tr>
                                        <td>Total Orders</td>
{{--                                        <td><?= $ordCount; ?></td>--}}
                                    ...
                                    <tr>
                                        <td>Member Since</td>
                                        <td> {{ date('d-m-Y', strtotime($user_info->since  ?? "N/A"))}} </td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row mgbt-xs-0">
                                                        ...
                                                        <div class="col-7 controls">{{$user_info->billing_name   ?? "N/A"  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Billing Phone:</label>
                                                        <div class="col-7 controls">{{$user_info->billing_phone  ?? "N/A"  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Billing Email:</label>
                                                        <div class="col-7 controls">{{$user_info->email  ?? "N/A"  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Billing Address:</label>
                                                        <div class="col-7 controls">{{$user_info->billing_address  ?? "N/A"  ?? "N/A"}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Modal -->
                                                        ...
                                                        <form action="{{route('updateBill')}}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="alert alert-success alert-block" style="display:none;" id="CartMsg"></div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="billName" type="text" class="form-control" id="billName" value="{{$user_info->billing_name  ?? "N/A"}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="billPhone">Billing Phone</label>
                                                                    <input name="billPhone" type="text" class="form-control" id="billPhone" value="{{$user_info->billing_phone  ?? "N/A"}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="billAddress">Billing Address</label>
                                                                    <input name="billAddress" type="text" class="form-control" id="billAddress" value="{{$user_info->billing_address  ?? "N/A"}}">
                                                                </div>
                                                                <!-- <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <div class="row mgbt-xs-0">
                                                        ...
                                                        <div class="col-7 controls">{{$user_info->shipping_name  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Shipping Phone</label>
                                                        <div class="col-7 controls">{{$user_info->shipping_phone  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Shipping Email:</label>
                                                        <div class="col-7 controls">{{$user_info->email  ?? "N/A"}}</div>
                                                    </div>
                                                    <div class="row mgbt-xs-0">
                                                        <label class="col-5 control-label">Shipping Address</label>
                                                        <div class="col-7 controls">{{$user_info->shipping_info  ?? "N/A"}}</div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        @csrf
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="ShipName" type="text" class="form-control" id="ShipName" value="{{$user_info->shipping_name  ?? "N/A"}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="shipPhone">Shipping Phone</label>
                                                                    <input name="shipPhone" type="text" class="form-control" id="shipPhone" value="{{$user_info->shipping_phone  ?? "N/A"}}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="shipAddress">Shipping Address</label>
                                                                    <input name="shipAddress" type="text" class="form-control" id="shipAddress" value="{{$user_info->shipping_info  ?? "N/A"}}">
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-medium btn-default" data-dismiss="modal">Close</button>
